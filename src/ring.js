...
class Ring extends Shape {
  ...
  // 边界依赖于最大圆
  get lineBoundings() {
    const radius = Math.max(this.attr('innerRadius'), this.attr('outterRadius'));
  ...
  render(t, ctx) {
    super.render(t, ctx);
    const innerRadius = Math.min(this.attr('innerRadius'), this.attr('outterRadius'));
    const outterRadius = Math.max(this.attr('innerRadius'), this.attr('outterRadius'));
