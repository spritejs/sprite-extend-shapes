...
/* harmony import */ var _polyline__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
...
/* harmony import */ var _polycurve__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(109);
...
/* harmony import */ var _wave__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(110);
...
/* harmony import */ var _ring__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(111);
...
/* harmony import */ var _polygon__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(112);
...
/* harmony import */ var _triangle__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(113);
...
/* harmony import */ var _rect__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(114);
...
/* harmony import */ var _star__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(115);
...
/* harmony import */ var _ellipseSector__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(5);
...
/* harmony import */ var _ellipseArc__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(3);
...
/* harmony import */ var _sector__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(4);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return install; });
/* harmony import */ var _shape__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _ellipseArc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function install({
  ...
  const {
    EllipseArc
  } = use(_ellipseArc__WEBPACK_IMPORTED_MODULE_1__["default"], null, false);
  const reflow = true;

  let ArcAttr = _decorate(null, function (_initialize, _EllipseArc$Attr) {
    class ArcAttr extends _EllipseArc$Attr {
      constructor(subject) {
        super(subject);
  ...
  _defineProperty(Arc, "Attr", ArcAttr);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return install; });
/* harmony import */ var _shape__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _sector__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
function install({
  ...
  let EllipseArc = _decorate(null, function (_initialize, _Shape) {
    class EllipseArc extends _Shape {
      constructor(...args) {
        super(...args);
    ...
    return {
      ...
      d: [{
        ...
        value: function pointCollision(evt) {
          if (_get(_getPrototypeOf(EllipseArc.prototype), "pointCollision", this).call(this, evt)) {
            let {
              offsetX,
              offsetY
            } = evt;
            ...
            if (Math.abs(dx ** 2 / rx ** 2 + dy ** 2 / ry ** 2 - 1) <= 2 * lw / (rx + ry)) {
              ...
              const angle = Object(_util__WEBPACK_IMPORTED_MODULE_2__["angleOf"])([dx, dy]);
        ...
        value: function render(t, drawingContext) {
          _get(_getPrototypeOf(EllipseArc.prototype), "render", this).call(this, t, drawingContext);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return install; });
/* harmony import */ var _ellipseSector__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
    ...
    render(t, drawingContext) {
      ...
      if (this.points) {
        ...
        if (!this.path || !Object(_util__WEBPACK_IMPORTED_MODULE_2__["pointsEqual"])(this.path.points, this.points)) {
          ...
          if (smooth) {
            d += Object(_util__WEBPACK_IMPORTED_MODULE_2__["makeSmoothCurveLine"])(this.points, 0);
          } else {
...
var _matrix = __webpack_require__(101);
...
var _a2c = __webpack_require__(107);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return install; });
/* harmony import */ var svg_path_to_canvas__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
            ...
            if (!this.path || !Object(_util__WEBPACK_IMPORTED_MODULE_2__["pointsEqual"])(this.path.points, this.points)) {
              ...
              if (!smooth) {
                ...
                smooth.forEach((arr, iind) => {
                  ...
                  d += Object(_util__WEBPACK_IMPORTED_MODULE_2__["makeSmoothCurveLine"])(smoothPoints, smoothStart);
                  subIndex = smoothEnd;
                });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return install; });
/* harmony import */ var _polygon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(112);
...
module.exports = {"name":"@spritejs/shapes","version":"1.1.7","description":"","main":"dist/sprite-extend-shapes.js","module":"dist/sprite-extend-shapes.esm.js","directories":{"example":"examples","lib":"lib","test":"test"},"scripts":{"build":"npm run build:es6 && npm run build:prod && npm run build:nobrowser","build:prod":"babel src -d lib && webpack --env.production","build:es6":"babel src -d lib && webpack --env.esnext","build:nobrowser":"babel src -d lib && webpack --env.nobrowser","standalone":"babel src -d lib && webpack --env.standalone","start":"webpack-dev-server --watch-poll","prepublishOnly":"npm run build","test":"nyc ava --serial && rimraf ./coverage && mkdir coverage && nyc report --reporter=html > ./coverage/lcov.info","lint":"eslint ./ --fix"},"author":"akira-cn","license":"MIT","devDependencies":{"@babel/cli":"^7.2.0","@babel/core":"^7.2.0","@babel/plugin-external-helpers":"^7.2.0","@babel/plugin-proposal-class-properties":"^7.2.1","@babel/plugin-proposal-decorators":"^7.2.0","@babel/plugin-transform-runtime":"^7.2.0","@babel/preset-env":"^7.2.0","@purtuga/esm-webpack-plugin":"^1.1.1","@babel/register":"^7.0.0","ava":"^1.4.1","babel-eslint":"^10.0.1","babel-loader":"^8.0.5","canvas":"^2.0.0-alpha.16","canvas-5-polyfill":"^0.1.5","colors":"^1.3.1","coveralls":"^3.0.2","css-loader":"^2.0.0","eslint":"^5.0.1","eslint-config-sprite":"^1.0.4","eslint-plugin-html":"^4.0.5","hamming-distance":"^1.0.0","html-webpack-plugin":"^3.2.0","imghash":"^0.0.3","nyc":"^12.0.2","pixelmatch":"^4.0.2","rimraf":"^2.6.2","spritejs":"^2.29.2","style-loader":"^0.23.1","webpack":"^4.35.0","webpack-bundle-analyzer":"^3.0.3","webpack-cli":"^3.3.5","webpack-dev-server":"^3.7.2","webpack-hot-middleware":"^2.24.3","webpack-merge":"^4.1.5"},"ava":{"files":["**/test/*.test.js"],"require":["@babel/register"],"babel":{"testOptions":{"babelrc":true}}},"nyc":{"exclude":["**/test/**/*.js"]},"dependencies":{"@babel/runtime":"^7.2.0","sprite-draggable":"0.1.15","svg-path-to-canvas":"^1.11.3"}};

/***/ })
/******/ ]);

export const Shapes = spriteShapes['Shapes'];
export const version = spriteShapes['version'];
export const install = spriteShapes['install'];
export const Shape = spriteShapes['Shape'];
export const Polyline = spriteShapes['Polyline'];
export const Polycurve = spriteShapes['Polycurve'];
export const Wave = spriteShapes['Wave'];
export const Polygon = spriteShapes['Polygon'];
export const Triangle = spriteShapes['Triangle'];
export const Rect = spriteShapes['Rect'];
export const Star = spriteShapes['Star'];
export const Arc = spriteShapes['Arc'];
export const Sector = spriteShapes['Sector'];
export const Ellipse = spriteShapes['Ellipse'];
export const EllipseSector = spriteShapes['EllipseSector'];
export const EllipseArc = spriteShapes['EllipseArc'];
export const Circle = spriteShapes['Circle'];
export const Ring = spriteShapes['Ring'];
export default spriteShapes['default'];
