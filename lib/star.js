...
function install(_ref) {
  ...
  var PolygonAttr = _decorate(null, function (_initialize, _Polygon$Attr) {
    ...
    function (_Polygon$Attr2) {
      ...
      function PolygonAttr(subject) {
        ...
        _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(PolygonAttr).call(this, subject));
  ...
  /*#__PURE__*/
  function (_Polygon) {
    (0, _inherits2.default)(Star, _Polygon);
  ...
  (0, _defineProperty2.default)(Star, "Attr", PolygonAttr);
