...
function install(_ref) {
  ...
  var rectAttr = _decorate(null, function (_initialize, _Polygon$Attr) {
    ...
    function (_Polygon$Attr2) {
      ...
      function rectAttr(subject) {
        ...
        _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(rectAttr).call(this, subject));
  ...
  /*#__PURE__*/
  function (_Polygon) {
    (0, _inherits2.default)(Rect, _Polygon);
  ...
  (0, _defineProperty2.default)(Rect, "Attr", rectAttr);
