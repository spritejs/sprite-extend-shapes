      ...
      value: function render(t, drawingContext) {
        ...
        if (this.points.length) {
          ...
          if (!smooth) {
            ...
            var smoothStart = smooth[0];
            var smoothEnd = smooth[1];
            // const beforeSmoothPoints = points.slice(0, smoothStart);
            for (var i = 0; i < smoothStart; i++) {
              if (i === 0) {
            ...
            for (var _i = smoothEnd + 1; _i < points.length; _i++) {
              path.lineTo(points[_i][0], points[_i][1]);
            }
          }
          path.closePath();
